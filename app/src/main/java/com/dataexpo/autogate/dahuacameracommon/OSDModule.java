...
public class OSDModule {
    private static final String TAG = OSDModule.class.getSimpleName();
    ...
    public boolean getTimeTitle(int channel) {
        ...
        // 获取
        if(!INetSDK.GetConfig(MainApplication.getInstance().getLoginHandle(), NET_EM_CFG_OPERATE_TYPE.NET_EM_CFG_TIMETITLE, channel, timeTitle, 5000, null)) {
            Log.i(TAG, "Get Faile");
            return false;
        }
    ...
    public boolean setTimeTitle(int channel,  boolean bBlend, boolean bShowWeek) {
        ...
        if(!INetSDK.SetConfig(MainApplication.getInstance().getLoginHandle(), NET_EM_CFG_OPERATE_TYPE.NET_EM_CFG_TIMETITLE, channel, timeTitle, 5000, null, null)) {
            return false;
        }
    ...
    public boolean getChannelTitle(int channel) {
        ...
        // 获取
        if(!INetSDK.GetConfig(MainApplication.getInstance().getLoginHandle(), NET_EM_CFG_OPERATE_TYPE.NET_EM_CFG_CHANNELTITLE, channel, channelTitle, 5000, null)) {
            Log.i(TAG, "get bEncodeBlend failed");
            return false;
        }
        Log.i(TAG, "bEncodeBlend:" + channelTitle.bEncodeBlend);
        return true;
    }
    ...
    public boolean setChannelTitle(int channel,  boolean bBlend) {
        ...
        if(!INetSDK.SetConfig(MainApplication.getInstance().getLoginHandle(), NET_EM_CFG_OPERATE_TYPE.NET_EM_CFG_CHANNELTITLE, channel, channelTitle, 5000, null, null)) {
            return false;
        }
        return true;
    }
    ...
    public boolean getChannelName(int channel) {
        ...
        channelTitleName = new AV_CFG_ChannelName();
        if(!ToolKits.GetDevConfig(FinalVar.CFG_CMD_CHANNELTITLE, channelTitleName, MainApplication.getInstance().getLoginHandle(), channel, 2048)) {
            return false;
        }
    ...
    public boolean setChannelName(int channel, String channelName) {
        ...
        if(!ToolKits.SetDevConfig(FinalVar.CFG_CMD_CHANNELTITLE, channelTitleName,  MainApplication.getInstance().getLoginHandle(), channel, 2048)) {
            return false;
        }
